...
def save_outputs(result, output_dir, base_filename):
    ...
    # 2. Sauvegarder l'Excel complet
    excel_file = None  # ← INITIALISER ICI
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python transform_grand_livre_compte_excel.py <input_file> <output_dir>")
        sys.exit(1)
